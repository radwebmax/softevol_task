На задание потратил около 5 часов. Эстимейт был на 3. Ньюансы возникли во время вёрстки адаптива - довольно не стандартные брейк-поинты и отступы, требующие кучи лишних строк кода.
